...
`;function ft(t){return 5*(t-32)/9}const vt={PLEASANT:"Comfortable",COLD:"Cold",HOT:"Hot",DRY:"Dry",HUMID:"Humid","COLD & DRY":"Cold & dry","COLD & HUMID":"Cold & humid","HOT & DRY":"Hot & dry","HOT & HUMID":"Hot & humid"};const _t={good:0,moderate:1,poor:2},$t={good:"Good",moderate:"Moderate",poor:"Poor"},bt={co2:{good:800,warning:1200,poor:1500},no2:{good:50,warning:150,poor:250},pm1:{good:10,warning:25,poor:50},pm25:{good:15,warning:35,poor:75},pm10:{good:45,warning:100,poor:150},radon:{good:100,warning:150,poor:300},voc:{good:150,warning:250,poor:400}};function xt(t){return t.value<=t.good?"good":t.value<=t.warning?"moderate":"poor"}const wt={PLEASANT:0,COLD:1,HOT:1,DRY:1,HUMID:1,"COLD & DRY":2,"COLD & HUMID":2,"HOT & DRY":2,"HOT & HUMID":2},Et={good:0,moderate:1,poor:2},At={good:"Clean air",moderate:"Moderate air",poor:"Poor air"};function Ct(t,e,i){const o=function(t){return wt[t]??1}(t),r=e?(s=e.level,Et[s]):0;var s;const n=Math.max(o,r),a=null!==e&&r>0&&r>=o?i?.airQuality[e.level]??At[e.level]:i?.status[t]??function(t){return vt[t]??t}(t);return{label:a,severity:n}}const St={card:{title:"Air Comfort",entityNotFound:"Entity not found",invalidSensorValues:"Invalid sensor values"},dial:{hot:"HOT",humid:"HUMID",cold:"COLD",dry:"DRY"},readings:{temperature:"Temperature",humidity:"Humidity"},history:{show:"Show 24-hour history",hide:"Hide 24-hour history",chartSuffix:"(24h)"},status:{PLEASANT:"Comfortable",COLD:"Cold",HOT:"Hot",DRY:"Dry",HUMID:"Humid","COLD & DRY":"Cold & dry","COLD & HUMID":"Cold & humid","HOT & DRY":"Hot & dry","HOT & HUMID":"Hot & humid"},airQuality:{good:"Clean air",moderate:"Moderate air",poor:"Poor air"},thresholds:{cold:"Cold",hot:"Hot",dry:"Dry",wet:"Wet",good:"Good",stuffy:"Stuffy",poor:"Poor",warning:"Warning"},sensors:{temperature:"Temperature",humidity:"Humidity",co2:"CO₂",no2:"NO₂",pm1:"PM 1",pm25:"PM 2.5",pm10:"PM 10",radon:"Radon",voc:"VOC"},editor:{cardTitle:"Card Title",temperatureSection:"Temperature",temperatureEntity:"Temperature Entity",displayUnit:"Display Unit",celsius:"°C (Celsius)",fahrenheit:"°F (Fahrenheit)",comfortRange:"Comfort Range",humiditySection:"Humidity",humidityEntity:"Humidity Entity",comfortRangeHumidity:"Comfort Range (%)",airQualitySection:"Air Quality",co2Entity:"CO₂ Entity",no2Entity:"NO₂ Entity",pm1Entity:"PM 1 Entity",pm25Entity:"PM 2.5 Entity",pm10Entity:"PM 10 Entity",radonEntity:"Radon Entity",vocEntity:"VOC Entity"}},Ht={en:St,de:{card:{title:"Luftkomfort",entityNotFound:"Entität nicht gefunden",invalidSensorValues:"Ungültige Sensorwerte"},dial:{hot:"WARM",humid:"FEUCHT",cold:"KALT",dry:"TROCKEN"},readings:{temperature:"Temperatur",humidity:"Luftfeuchtigkeit"},history:{show:"24-Stunden-Verlauf anzeigen",hide:"24-Stunden-Verlauf ausblenden",chartSuffix:"(24h)"},status:{PLEASANT:"Angenehm",COLD:"Kalt",HOT:"Warm",DRY:"Trocken",HUMID:"Feucht","COLD & DRY":"Kalt & trocken","COLD & HUMID":"Kalt & feucht","HOT & DRY":"Warm & trocken","HOT & HUMID":"Warm & feucht"},airQuality:{good:"Saubere Luft",moderate:"Mäßige Luft",poor:"Schlechte Luft"},thresholds:{cold:"Kalt",hot:"Warm",dry:"Trocken",wet:"Feucht",good:"Gut",stuffy:"Stickig",poor:"Schlecht",warning:"Warnung"},sensors:{temperature:"Temperatur",humidity:"Luftfeuchtigkeit",co2:"CO₂",no2:"NO₂",pm1:"PM 1",pm25:"PM 2,5",pm10:"PM 10",radon:"Radon",voc:"VOC"},editor:{cardTitle:"Kartentitel",temperatureSection:"Temperatur",temperatureEntity:"Temperatur-Entität",displayUnit:"Anzeigeeinheit",celsius:"°C (Celsius)",fahrenheit:"°F (Fahrenheit)",comfortRange:"Komfortbereich",humiditySection:"Luftfeuchtigkeit",humidityEntity:"Luftfeuchtigkeits-Entität",comfortRangeHumidity:"Komfortbereich (%)",airQualitySection:"Luftqualität",co2Entity:"CO₂-Entität",no2Entity:"NO₂-Entität",pm1Entity:"PM 1-Entität",pm25Entity:"PM 2,5-Entität",pm10Entity:"PM 10-Entität",radonEntity:"Radon-Entität",vocEntity:"VOC-Entität"}}};function Mt(t){const e=t?.split("-")[0]?.toLowerCase()??"en";return Ht[e]??St}const kt=new Set(["temperature_entity","humidity_entity","co2_entity","no2_entity","pm1_entity","pm25_entity","pm10_entity","radon_entity","voc_entity"]);let Dt=class extends nt{constructor(){super(...arguments),this._entityPickerAvailable=!1}connectedCallback(){super.connectedCallback(),async function(){if(customElements.get("ha-entity-picker"))return!0;try{const t=await(window.loadCardHelpers?.());if(t){const e=await t.createCardElement({type:"entities",entities:[]});await(e?.constructor?.getConfigElement?.())}}catch{}if(customElements.get("ha-entity-picker"))return!0;try{return await Promise.race([customElements.whenDefined("ha-entity-picker"),new Promise((t,e)=>setTimeout(()=>e(new Error("timeout")),3e3))]),!0}catch{return!1}}().then(t=>{this._entityPickerAvailable=t})}setConfig(t){this.config=mt(t)}render(){if(!this.config)return Y;const t=Mt(this.hass?.language),e=this.config.temperature_unit||"C",i="F"===e?"°F":"°C",o="F"===e?"temp_f_min":"temp_c_min",r="F"===e?"temp_f_max":"temp_c_max",s="F"===e?68:20,n="F"===e?75:24;return L`
    ...
    `}_entityChanged(t){return e=>{this._updateConfig(t,e.detail.value||void 0)}}_valueChanged(t){const e=t.target,i=e.id;let o;e instanceof HTMLSelectElement?o=e.value:"checkbox"===e.type?o=e.checked:"number"===e.type?o=""===e.value?void 0:parseFloat(e.value):(o=e.value,""===o&&kt.has(i)&&(o=void 0)),this._updateConfig(i,o)}_updateConfig(t,e){this.config&&(this.config={...this.config,[t]:e},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this.config},bubbles:!0,composed:!0})))}};Dt.styles=yt,t([ht({attribute:!1})],Dt.prototype,"hass",void 0),t([ct()],Dt.prototype,"config",void 0),t([ct()],Dt.prototype,"_entityPickerAvailable",void 0),Dt=t([lt("air-comfort-card-editor")],Dt);const Tt=16,Ot=8,Rt=20,Ft=40;const Pt=[6e4,3e5,6e5,9e5,18e5,36e5,72e5,144e5,216e5,432e5,864e5];function zt(t,e){const i=new Date(t);return e<12e4?i.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"}):i.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}let Ut=class extends nt{constructor(){super(...arguments),this.data=[],this.color="#4dabf7",this.unit="",this.thresholds=[],this._width=0}connectedCallback(){super.connectedCallback(),this.ro=new ResizeObserver(([t])=>{const e=t?.contentRect.width??0;Math.abs(e-this._width)>1&&(this._width=e,this.requestUpdate())}),this.ro.observe(this),this._width=this.clientWidth}disconnectedCallback(){super.disconnectedCallback(),this.ro?.disconnect()}get cw(){return Math.max(0,this._width-Ft-Ot)}get ch(){return 120-Tt-Rt}onMouseMove(t){if(this.data.length<2)return;const e=this.shadowRoot.querySelector("svg").getBoundingClientRect(),i=t.clientX-e.left-Ft,o=this.cw,r=this.data.map(t=>t.time.getTime()),s=r[0],n=r[r.length-1]-s||1,a=s+Math.max(0,Math.min(1,i/o))*n;let l=0,d=this.data.length-1;for(;l<d;){const t=l+d>>1;this.data[t].time.getTime()<a?l=t+1:d=t}const h=l>0&&Math.abs(this.data[l-1].time.getTime()-a)<Math.abs(this.data[l].time.getTime()-a)?l-1:l,c=this.data[h],p=Ft+(c.time.getTime()-s)/n*o,u=this.shadowRoot.querySelector(".crosshair");u&&(u.setAttribute("x1",p.toFixed(1)),u.setAttribute("x2",p.toFixed(1)),u.style.display="");const m=this.shadowRoot.querySelector(".tooltip");if(m){const t=zt(c.time.getTime(),n);m.textContent=`${t} · ${c.value.toFixed(1)}${this.unit}`,m.style.display="block";const e=p+10;m.style.left=`${Math.min(e,this._width-150)}px`}}onMouseLeave(){const t=this.shadowRoot.querySelector(".crosshair");t&&(t.style.display="none");const e=this.shadowRoot.querySelector(".tooltip");e&&(e.style.display="none")}render(){if(this._width<10||this.data.length<2)return L``;const t=this.cw,e=this.ch,i=this.data.map(t=>t.time.getTime()),o=i[0],r=i[i.length-1],s=r-o||1,n=this.data.map(t=>t.value),a=Math.min(...n),l=Math.max(...n),d=.1*(l-a)||1,h=a-d,c=l+d-h,p=e=>(e-o)/s*t,u=t=>(1-(t-h)/c)*e,m=this.data.map(t=>[p(t.time.getTime()),u(t.value)]),y=function(t){if(t.length<2)return"";let e=`M ${t[0][0].toFixed(1)},${t[0][1].toFixed(1)}`;for(let i=0;i<t.length-1;i++){const o=t[Math.max(0,i-1)],r=t[i],s=t[i+1],n=t[Math.min(t.length-1,i+2)],a=r[0]+(s[0]-o[0])/6,l=r[1]+(s[1]-o[1])/6,d=s[0]-(n[0]-r[0])/6,h=s[1]-(n[1]-r[1])/6;e+=` C ${a.toFixed(1)},${l.toFixed(1)} ${d.toFixed(1)},${h.toFixed(1)} ${s[0].toFixed(1)},${s[1].toFixed(1)}`}return e}(m),g=`${y} L ${m[m.length-1][0].toFixed(1)},${e} L ${m[0][0].toFixed(1)},${e} Z`,f=function(t,e,i=4){if(t===e)return[t];const o=(e-t)/(i-1),r=Math.pow(10,Math.floor(Math.log10(o))),s=([1,2,5,10].find(t=>t*r>=o)??10)*r,n=Math.floor(t/s)*s,a=[];for(let i=0;;i++){const o=Math.round(1e9*(n+i*s))/1e9;if(o>e+.01*s)break;o>=t-.5*s&&a.push(o)}return a}(a,l),v=function(t,e,i=6){const o=e-t;if(o<=0)return[t];const r=o/(i-1),s=Pt.find(t=>t>=r)??Pt[Pt.length-1],n=[];for(let i=Math.ceil(t/s)*s;i<=e+.01*s;i+=s)n.push(i);return n}(o,r);return L`
      ...
      >
        <!-- Y axis labels -->
        ${f.map(t=>{const i=Tt+u(t);return i<Tt-2||i>Tt+e+2?"":N`
            <text
              x="${Ft-4}" y="${i}"
        ...
        <svg x="${Ft}" y="${Tt}" width="${t}" height="${e}" overflow="hidden">
          <!-- Y grid lines -->
  ...
  `,t([ht({attribute:!1})],Ut.prototype,"data",void 0),t([ht()],Ut.prototype,"color",void 0),t([ht()],Ut.prototype,"unit",void 0),t([ht({attribute:!1})],Ut.prototype,"thresholds",void 0),Ut=t([lt("svg-line-chart")],Ut);let Lt=class extends nt{constructor(){super(...arguments),this.dialSize=280,this.temperatureHistory=[],this.humidityHistory=[],this.co2History=[],this.no2History=[],this.pm1History=[],this.pm25History=[],this.pm10History=[],this.radonHistory=[],this.vocHistory=[],this.historyExpanded=!1,this.lastHistoryFetch=0}static getStubConfig(){return{type:"custom:air-comfort-card",temperature_entity:"sensor.temperature",humidity_entity:"sensor.humidity",co2_entity:"",no2_entity:"",pm1_entity:"",pm25_entity:"",pm10_entity:"",radon_entity:"",voc_entity:"",temperature_unit:"C",temp_c_min:20,temp_c_max:24,temp_f_min:68,temp_f_max:75,humidity_min:40,humidity_max:60,show_dial:!0,history_expanded:!1}}static getConfigElement(){return document.createElement("air-comfort-card-editor")}setConfig(t){if(!t.temperature_entity)throw new Error("You need to define a temperature_entity");if(!t.humidity_entity)throw new Error("You need to define a humidity_entity");this.config={temperature_unit:"C",temp_c_min:20,temp_c_max:24,temp_f_min:68,temp_f_max:75,humidity_min:40,humidity_max:60,show_dial:!0,history_expanded:!1,...mt(t)},this.historyExpanded=this.config.history_expanded??!1}getCardSize(){return Math.max(3,Math.round(this.dialSize/90))}connectedCallback(){super.connectedCallback(),"undefined"!=typeof ResizeObserver&&(this.resizeObserver=new ResizeObserver(t=>{const e=t[0];e&&this.updateDialSize(e.contentRect.width)}),this.resizeObserver.observe(this)),this.updateDialSize(this.clientWidth),this.fetchHistory(),this.historyFetchInterval=window.setInterval(()=>{this.fetchHistory()},3e5)}disconnectedCallback(){this.resizeObserver?.disconnect(),this.resizeObserver=void 0,this.historyFetchInterval&&clearInterval(this.historyFetchInterval),super.disconnectedCallback()}async fetchHistory(){if(!this.hass||!this.config)return;const t=Date.now();if(t-this.lastHistoryFetch<6e4)return;this.lastHistoryFetch=t;const e=new Date,i=new Date(e.getTime()-864e5);try{const t=[this.config.temperature_entity,this.config.humidity_entity];this.config.co2_entity&&t.push(this.config.co2_entity),this.config.no2_entity&&t.push(this.config.no2_entity),this.config.pm1_entity&&t.push(this.config.pm1_entity),this.config.pm25_entity&&t.push(this.config.pm25_entity),this.config.pm10_entity&&t.push(this.config.pm10_entity),this.config.radon_entity&&t.push(this.config.radon_entity),this.config.voc_entity&&t.push(this.config.voc_entity);const o=await this.hass.callApi("GET",`history/period/${i.toISOString()}?filter_entity_id=${t.join(",")}&end_time=${e.toISOString()}&minimal_response&no_attributes`);if(!o||0===o.length)return;for(const t of o){if(0===t.length)continue;const e=t.filter(t=>!isNaN(parseFloat(t.state))).map(t=>({time:new Date(t.last_changed),value:parseFloat(t.state)})),i=t[0];i.entity_id===this.config.temperature_entity?this.temperatureHistory=e:i.entity_id===this.config.humidity_entity?this.humidityHistory=e:i.entity_id===this.config.co2_entity?this.co2History=e:i.entity_id===this.config.no2_entity?this.no2History=e:i.entity_id===this.config.pm1_entity?this.pm1History=e:i.entity_id===this.config.pm25_entity?this.pm25History=e:i.entity_id===this.config.pm10_entity?this.pm10History=e:i.entity_id===this.config.radon_entity?this.radonHistory=e:i.entity_id===this.config.voc_entity&&(this.vocHistory=e)}}catch(t){console.error("Error fetching history:",t)}}getSensorDefs(){const t=this.config;if(!t)return[];const e=Mt(this.hass?.language),i=(t,e,i)=>null!=t?{value:t,color:e,label:i}:null,o=(...t)=>t.filter(t=>null!==t),r=(e,i)=>{const o=t[e];return o&&this.hass?.states[o]?.attributes.unit_of_measurement||i},s=t.temperature_unit||"C",n=r("temperature_entity","°C"),a="°F"===n||"F"===n,l="F"===s,d=l?"°F":"°C",h=l&&!a?this.temperatureHistory.map(t=>{return{...t,value:(e=t.value,9*e/5+32)};var e}):!l&&a?this.temperatureHistory.map(t=>({...t,value:ft(t.value)})):this.temperatureHistory,c=l?t.temp_f_min:t.temp_c_min,p=l?t.temp_f_max:t.temp_c_max;return[{id:"temperature",icon:"mdi:thermometer",label:e.sensors.temperature,color:"#FFD700",unit:d,history:h,value:this.hass?.states[t.temperature_entity]?.state,show:!0,thresholds:o(i(c,"rgba(100,150,255,0.5)",e.thresholds.cold),i(p,"rgba(255,100,80,0.5)",e.thresholds.hot))},{id:"humidity",icon:"mdi:water-percent",label:e.sensors.humidity,color:"#40E0D0",unit:r("humidity_entity","%"),history:this.humidityHistory,value:this.hass?.states[t.humidity_entity]?.state,show:!0,thresholds:o(i(t.humidity_min,"rgba(255,180,50,0.5)",e.thresholds.dry),i(t.humidity_max,"rgba(80,160,255,0.5)",e.thresholds.wet))},{id:"co2",icon:"mdi:molecule-co2",label:e.sensors.co2,color:"#8B4513",unit:r("co2_entity","ppm"),history:this.co2History,value:t.co2_entity?this.hass?.states[t.co2_entity]?.state:void 0,show:!!t.co2_entity,thresholds:o(i(bt.co2.good,"rgba(100,220,100,0.5)",e.thresholds.good),i(bt.co2.warning,"rgba(255,180,50,0.5)",e.thresholds.stuffy),i(bt.co2.poor,"rgba(255,80,80,0.5)",e.thresholds.poor))},{id:"no2",icon:"mdi:smog",label:e.sensors.no2,color:"#ffa94d",unit:r("no2_entity",""),history:this.no2History,value:t.no2_entity?this.hass?.states[t.no2_entity]?.state:void 0,show:!!t.no2_entity,thresholds:o(i(bt.no2.good,"rgba(100,220,100,0.5)",e.thresholds.good),i(bt.no2.warning,"rgba(255,180,50,0.5)",e.thresholds.warning),i(bt.no2.poor,"rgba(255,80,80,0.5)",e.thresholds.poor))},{id:"pm1",icon:"mdi:blur-linear",label:e.sensors.pm1,color:"#9B59B6",unit:r("pm1_entity","µg/m³"),history:this.pm1History,value:t.pm1_entity?this.hass?.states[t.pm1_entity]?.state:void 0,show:!!t.pm1_entity,thresholds:o(i(bt.pm1.good,"rgba(100,220,100,0.5)",e.thresholds.good),i(bt.pm1.warning,"rgba(255,180,50,0.5)",e.thresholds.warning),i(bt.pm1.poor,"rgba(255,80,80,0.5)",e.thresholds.poor))},{id:"pm25",icon:"mdi:blur",label:e.sensors.pm25,color:"#7B2FBE",unit:r("pm25_entity","µg/m³"),history:this.pm25History,value:t.pm25_entity?this.hass?.states[t.pm25_entity]?.state:void 0,show:!!t.pm25_entity,thresholds:o(i(bt.pm25.good,"rgba(100,220,100,0.5)",e.thresholds.good),i(bt.pm25.warning,"rgba(255,180,50,0.5)",e.thresholds.warning),i(bt.pm25.poor,"rgba(255,80,80,0.5)",e.thresholds.poor))},{id:"pm10",icon:"mdi:blur-radial",label:e.sensors.pm10,color:"#74c0fc",unit:r("pm10_entity","µg/m³"),history:this.pm10History,value:t.pm10_entity?this.hass?.states[t.pm10_entity]?.state:void 0,show:!!t.pm10_entity,thresholds:o(i(bt.pm10.good,"rgba(100,220,100,0.5)",e.thresholds.good),i(bt.pm10.warning,"rgba(255,180,50,0.5)",e.thresholds.warning),i(bt.pm10.poor,"rgba(255,80,80,0.5)",e.thresholds.poor))},{id:"radon",icon:"mdi:radioactive",label:e.sensors.radon,color:"#FF10F0",unit:r("radon_entity","Bq/m³"),history:this.radonHistory,value:t.radon_entity?this.hass?.states[t.radon_entity]?.state:void 0,show:!!t.radon_entity,thresholds:o(i(bt.radon.good,"rgba(100,220,100,0.5)",e.thresholds.good),i(bt.radon.warning,"rgba(255,180,50,0.5)",e.thresholds.warning),i(bt.radon.poor,"rgba(255,80,80,0.5)",e.thresholds.poor))},{id:"voc",icon:"mdi:cloud-outline",label:e.sensors.voc,color:"#FF8C00",value:t.voc_entity?this.hass?.states[t.voc_entity]?.state:void 0,unit:r("voc_entity",""),history:this.vocHistory,show:!!t.voc_entity,thresholds:o(i(bt.voc.good,"rgba(100,220,100,0.5)",e.thresholds.good),i(bt.voc.warning,"rgba(255,180,50,0.5)",e.thresholds.warning),i(bt.voc.poor,"rgba(255,80,80,0.5)",e.thresholds.poor))}]}updateDialSize(t){if(!t)return;const e=Math.max(0,t-48);if(!e)return;let i=Math.min(320,e);e>=220&&(i=Math.max(220,i)),Math.abs(i-this.dialSize)>.5&&(this.dialSize=i)}render(){if(!this.config||!this.hass)return L``;const t=Mt(this.hass.language),e=this.hass.states[this.config.temperature_entity],i=this.hass.states[this.config.humidity_entity];if(!e||!i)return L`
      ...
      `;const o=parseFloat(e.state),r=parseFloat(i.state),s=e.attributes.unit_of_measurement||"°C";if(i.attributes.unit_of_measurement,isNaN(o)||isNaN(r))return L`
        <div class="card-content">
          <div class="card-header">
            <div class="card-title">${t.card.title}</div>
          </div>
      ...
      `;const n="°F"===s||"F"===s?ft(o):o;let a,l;"F"===(this.config.temperature_unit||"C")?(a=ft(this.config.temp_f_min??68),l=ft(this.config.temp_f_max??75)):(a=this.config.temp_c_min??20,l=this.config.temp_c_max??24);const{angle:d,radialDistance:h,statusText:c,tempDeviation:p,humidityDeviation:u}=function(t,e,i){const o=i?.tempMin??20,r=i?.tempMax??24,s=i?.humidityMin??40,n=i?.humidityMax??60;let a=0;t<o?a=o-t:t>r&&(a=t-r);let l=0;e<s?l=s-e:e>n&&(l=e-n);const d=0===a&&0===l;let h=0;if(d){const i=t-(o+r)/2,a=e-(s+n)/2;h=Math.atan2(-i,a)*(180/Math.PI),h=(h+90+360)%360}else{let i=0,a=0;t<o?i=t-o:t>r&&(i=t-r),e<s?a=e-s:e>n&&(a=e-n),h=Math.atan2(-i,a)*(180/Math.PI),h=(h+90+360)%360}const c=a/10,p=l/40,u=Math.sqrt(c*c+p*p);let m="PLEASANT";if(!d){const i=Math.abs(a),r=Math.abs(l);m=i>.5*r?t<o?r>5?e<s?"COLD & DRY":"COLD & HUMID":"COLD":r>5?e<s?"HOT & DRY":"HOT & HUMID":"HOT":e<s?i>1?t<o?"COLD & DRY":"HOT & DRY":"DRY":i>1?t<o?"COLD & HUMID":"HOT & HUMID":"HUMID"}return{angle:h,radialDistance:u,isInComfortZone:d,statusText:m,tempDeviation:a,humidityDeviation:l}}(n,r,{tempMin:a,tempMax:l,humidityMin:this.config.humidity_min,humidityMax:this.config.humidity_max}),m=.2*this.dialSize,y=.35*this.dialSize,g=(a+l)/2,f=((this.config.humidity_min??40)+(this.config.humidity_max??60))/2,v=(n-g)/Math.max(.5,(l-a)/2),_=(r-f)/Math.max(1,((this.config.humidity_max??60)-(this.config.humidity_min??40))/2),$=Math.max(Math.abs(v),Math.abs(_));let b;$<=1?b=$*m:(b=m+h*(y-m)/1.5,b=Math.min(b,y));const x=(d-90)*(Math.PI/180),w=b*Math.cos(x),E=b*Math.sin(x),A=this.calculateAirQuality(),{label:C,severity:S}=Ct(c,A,t);return L`
      <div class="card-content">
        <div class="card-header">
          <div class="card-title">${this.config.name||t.card.title}</div>
          <div class="status-badge">
            <span class="severity-dot severity-${S}"></span>
            ${C}
          </div>
        </div>
        ...
        >
          <div class="comfort-dial">
            ...
            <div
              ...
              style="transform: translate(-50%, -50%) translate(${w}px, ${E}px);"
            ></div>
...
`}toggleHistory(){this.historyExpanded=!this.historyExpanded}calculateAirQuality(){if(!this.config||!this.hass)return null;const t=[{entity:this.config.co2_entity,thresholds:bt.co2},{entity:this.config.no2_entity,thresholds:bt.no2},{entity:this.config.pm1_entity,thresholds:bt.pm1},{entity:this.config.pm25_entity,thresholds:bt.pm25},{entity:this.config.pm10_entity,thresholds:bt.pm10},{entity:this.config.radon_entity,thresholds:bt.radon},{entity:this.config.voc_entity,thresholds:bt.voc}],e=[];for(const{entity:i,thresholds:o}of t){if(!i)continue;const t=this.hass.states[i];if(!t)continue;const r=parseFloat(t.state);isNaN(r)||e.push({value:r,good:o.good,warning:o.warning})}return function(t){if(0===t.length)return null;let e="good";for(const i of t){const t=xt(i);_t[t]>_t[e]&&(e=t)}return{level:e,label:$t[e]}}(e)}handleHistoryToggleKeyDown(t){"Enter"!==t.key&&" "!==t.key||(t.preventDefault(),this.toggleHistory())}renderCharts(){const t=this.getSensorDefs().filter(t=>t.show);return 0===t.length?null:L`
      <div class="charts-container">
        ${t.map(t=>L`
          <div class="chart-wrapper">
            <div class="chart-label"><ha-icon .icon=${t.icon} style="--mdc-icon-size: 18px; vertical-align: middle; margin-right: 4px;"></ha-icon>${t.label}${t.value?L`<span class="chart-value">${t.value} ${t.unit}</span>`:""}</div>
            <svg-line-chart
              .data=${t.history}
              .color=${t.color}
              .unit=${t.unit}
    ...
    `}};Lt.styles=gt,t([ht({attribute:!1})],Lt.prototype,"hass",void 0),t([ct()],Lt.prototype,"config",void 0),t([ct()],Lt.prototype,"dialSize",void 0),t([ct()],Lt.prototype,"temperatureHistory",void 0),t([ct()],Lt.prototype,"humidityHistory",void 0),t([ct()],Lt.prototype,"co2History",void 0),t([ct()],Lt.prototype,"no2History",void 0),t([ct()],Lt.prototype,"pm1History",void 0),t([ct()],Lt.prototype,"pm25History",void 0),t([ct()],Lt.prototype,"pm10History",void 0),t([ct()],Lt.prototype,"radonHistory",void 0),t([ct()],Lt.prototype,"vocHistory",void 0),t([ct()],Lt.prototype,"historyExpanded",void 0),Lt=t([lt("air-comfort-card")],Lt),window.customCards=window.customCards||[],window.customCards.push({type:"air-comfort-card",name:"Air Comfort Card",description:"A card that visualizes indoor air comfort using temperature and humidity",preview:!1,documentationURL:"https://github.com/mrded/ha-air-comfort-card"});export{Lt as AirComfortCard};
